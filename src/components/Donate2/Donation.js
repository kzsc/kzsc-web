...
class Donation extends Component {
  ...
  handleChangeDonateOptions(event) {
    ...
    console.log(price)
    let priceToNumber = price.replace(/[$]/g,"")
  ...
  onStripeCheckoutClosed(){
    console.log("Closed Stripe Checkout")
  }
          ...
          <Segment padded color='grey' tertiary>
            <Form>
              ...
              { this.state.donationEditable ?
                <input type="text" className='input-segment-kblue' name="donationAmount" width={3} value={ this.state.donationAmount === 0 ? '$0.00' : '$' + this.state.donationAmount } onChange={this.handleChangeDonateOptions} />
                :
